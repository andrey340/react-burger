...
describe('constructor', function () {
        ...
        it('constructor check', function () {
            ...
            //Drag
            cy.get('#643d69a5c3f7b9001cfa093c').drag('[class^=burger-constructor_ingredients]').then((success) => {assert.isTrue(success)})
            cy.get('#643d69a5c3f7b9001cfa0941').drag('[class^=burger-constructor_ingredients]').then((success) => {assert.isTrue(success)})
            cy.get('#643d69a5c3f7b9001cfa0942').drag('[class^=burger-constructor_ingredients]').then((success) => {assert.isTrue(success)})
